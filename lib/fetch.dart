...
class _FetchDataState extends State<FetchData> {
  Query dbRef = FirebaseDatabase.instance.ref().child('attendence');
  //DatabaseReference reference = FirebaseDatabase.instance.ref().child('Students');

  Widget listItem({required Map Attendence}) {
    return Container(
        ...
        body: Container(
          ...
          child: FirebaseAnimatedList(
            ...
            itemBuilder: (BuildContext context, DataSnapshot snapshot,
              ...
              Map Attendence = snapshot.value as Map;
              Attendence['key'] = snapshot.key;

              return listItem(Attendence: Attendence);
            },
          ),
        ));
  }
